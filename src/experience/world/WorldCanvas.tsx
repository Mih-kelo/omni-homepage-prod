 ...
 * Refined to near-emptiness: the only ambient elements are the faint
 * star-field and the graded atmosphere. All decorative set-pieces have
 * been removed so the storytelling belongs to the content and the
 * vertical timeline; the world is only quiet depth behind them.
